...
// g++ problem307.cpp -lgmp -I$HOME/gmp/include -L$HOME/gmp/lib -O3
...
#include<stdio.h> // must include before gmp.h to use mpf_out_str
#include<gmp.h>
...
int main()
{
    mpf_set_default_prec(PRECISION); // set the precision of floating point numbers to 20
    ...
    for (ui n_chips_2_defects = 0; n_chips_2_defects <= mpz_get_ui(MPZ_M) / 2; n_chips_2_defects++)
    {
